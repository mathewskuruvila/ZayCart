...
exports.userLogin=(req,res)=>{
    ...
    //     console.log("inside home redirect");
    //     res.redirect('/user_home')
    // }else{
...
// exports.paymentSuccess=(req,res)=>{
        // let method = req.query.value
        // let bill = req.session.discountedBill
        // console.log(method)
        // console.log(bill)
        // let coupon = req.session.coupon || ''
        // let sessionUser = req.session.userId

        // if(method === "cod"){
        //     newOrder(method,bill,coupon,sessionUser)
        //      .then(()=>{
...
//     let paymentMode = req.body.paymentType
//     let discountedBill = req.body.Bill
...
exports.paypal = (req, res) => {
    ...
    'client_id': 'ASGy0bvy0la-eqBw_1nqALjIiMGaq8CEtNGr2wcQ_pdOj61rkxnhk8TWc8AEQWA0Al5IOTc-M1_a29G0', 
    // please provide your client id here 
    'client_secret': 'EHVSrmbA7GYUrmz5-6qBYD6H95ZK5rWxR80S7tiFJmy2OyVjf162TxZuMXUskFNr8kZBt984OZIcP4C5' // provide your client secret here 
    });
